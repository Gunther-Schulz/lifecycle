...
| A10 THE EXISTING CARRIERS vs the design's five mechanisms — items, runbooks, directives, ledger and records were EACH built to solve a piece of this; what do they already cover, where do they overlap, and where does the handoff between them fail so the right action does not fire at the right time (operator-named, 2026-09-18) | dark (modelled) | — | — | map each of the five carriers to the mechanism(s) it already implements; find the seams where one ends and none picks up |
